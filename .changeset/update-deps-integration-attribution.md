...
Update dependencies and add SDK integration attribution.
...
- Look snapshots up with the server-side `name` filter (e2b 2.34+) instead of paging through every team snapshot.
